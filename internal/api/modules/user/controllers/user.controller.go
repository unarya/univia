...
func GetUser(c *gin.Context) {
	...
	if cachedUser, err := redis.GetJSON[map[string]interface{}](redis.Redis, cacheKey); err == nil && cachedUser != nil {
	...
	// Save to Redis
	_ = redis.Redis.SetJSON(cacheKey, userInfo, 30*time.Minute)
...
func GetUserAvatar(c *gin.Context) {
	...
	// Save to Redis
	_ = redis.Redis.SetJSON(cacheKey, avatarUser, 30*time.Minute)
